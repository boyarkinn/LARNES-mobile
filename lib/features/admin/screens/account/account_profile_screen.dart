...
class AdminAccountProfileScreen extends StatefulWidget {
  const AdminAccountProfileScreen({super.key});

  @override
  State<AdminAccountProfileScreen> createState() => _AdminAccountProfileScreenState();
}

class _AdminAccountProfileScreenState extends State<AdminAccountProfileScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final user = await AuthScope.of(context).adminAccountApi.updateProfile(
  ...
  Widget build(BuildContext context) {
    ...
    return AdminAccountScaffold(
      title: l10n.adminAccountProfileTitle,
