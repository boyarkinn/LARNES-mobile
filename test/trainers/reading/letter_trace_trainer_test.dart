...
void main() {
  group('LetterTraceTrainer', () {
    testWidgets('uses TrainerScene full-bleed without legacy instruction text', (tester) async {
      ...
      expect(find.byType(LetterTracePad), findsOneWidget);
      expect(find.textContaining('Обведи букву'), findsNothing);
    ...
    testWidgets('fills bounded stage', (tester) async {
      const stageKey = Key('letter-trace-stage');
