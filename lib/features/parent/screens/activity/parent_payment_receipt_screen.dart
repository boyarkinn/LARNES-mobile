...
import 'package:larnes_mobile/features/parent/widgets/activity/parent_payment_receipt_summary.dart';
import 'package:larnes_mobile/features/parent/widgets/parent_panel_error_panel.dart';
import 'package:larnes_mobile/features/parent/widgets/parent_scaffold.dart';
import 'package:larnes_mobile/l10n/app_localizations.dart';
import 'package:larnes_mobile/l10n/l10n_extensions.dart';

/// L3 чек — read-only breakdown.
class ParentPaymentReceiptScreen extends StatefulWidget {
  const ParentPaymentReceiptScreen({
    super.key,
  ...
  @override
  State<ParentPaymentReceiptScreen> createState() => _ParentPaymentReceiptScreenState();
}

class _ParentPaymentReceiptScreenState extends State<ParentPaymentReceiptScreen> {
  bool _isLoading = true;
  String? _error;
  String? _errorCode;
  ParentActivityReceiptDetailPage? _detail;
  ...
  Future<void> _load({bool silent = false}) async {
    ...
    try {
      ...
      final detail = await AuthScope.of(context).parentApi.fetchPaymentReceipt(
        widget.childId,
        widget.batchId,
        locale: locale,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return ParentScaffold(
      title: l10n.parentActivityPaymentReceiptTitle,
        ...
        children: [
          Center(
            child: ConstrainedBox(
              ...
              child: ParentPaymentReceiptSummary(
                detail: detail,
                l10n: l10n,
              ),
            ),
